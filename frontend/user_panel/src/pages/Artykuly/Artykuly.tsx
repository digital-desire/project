    ...
    return (
        <>
            ...
            <Grid container spacing={3}>
                <Grid item xs={4}>
                    <NaglowekStyled>Filtry</NaglowekStyled>
                    <NazwaFiltra>Szukaj w...</NazwaFiltra>

                    <FiltrCheckbox />
                    <NazwaFiltra>Kryterium #2</NazwaFiltra><PrzedzialDat >
                        <PoleTekstowe /><Typography marginLeft="10px" marginRight="10px"></Typography><PoleTekstowe /></PrzedzialDat>
                    <NazwaFiltra>Kryterium #3</NazwaFiltra>
                    <PrzedzialDat><PoleTekstowe /></PrzedzialDat>
                    <NazwaFiltra>Kryterium #4</NazwaFiltra>
                    <FiltrRadio />
                    <ButtonFiltry>Filtruj</ButtonFiltry>
                </Grid>
                <Grid item xs={8}>
